...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'step-item': 'flex items-center gap-3 py-2 px-4 rounded-[10px] border-l-3 border-l-solid bg-slate-800/40',
    'step-item-sm': 'flex items-center gap-3 py-1.5 px-4 rounded-[10px] border-l-3 border-l-solid bg-slate-800/40',
    'step-item-xs': 'flex items-center gap-2 py-1 px-3 rounded-[10px] border-l-3 border-l-solid bg-slate-800/40',
    ...
    'mini-stat': 'text-center px-4 py-2 rounded-10px bg-slate-800/40 border',
  },
})
